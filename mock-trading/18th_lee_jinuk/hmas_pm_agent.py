...
class PMAgent(BaseAgent):
    ...
    def run(
        ...
        ----------
        ticker       : Stock ticker.
        macro_output : MacroAgentOutput from MacroAgent.
        sector_output: SectorAgentOutput from SectorAgent.
        macro_regime : "Risk-On" | "Risk-Off" | "Transitional"

        Returns
        -------
        PMAgentOutput : final_score (0-100) + Korean reason.
        """
    ...
    def stub_output(
        ...
        from hmas_base import MacroAgentOutput, SectorAgentOutput
